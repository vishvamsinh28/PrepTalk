            ...
            >
              <div className="rounded-3xl border border-white/10 bg-slate-950/50 p-5">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="aspect-video rounded-2xl bg-linear-to-br from-cyan-300/20 via-slate-500/20 to-blue-400/20 p-4">
                  ...
                  <div className="aspect-video rounded-2xl bg-linear-to-br from-emerald-300/20 via-slate-500/20 to-cyan-300/20 p-4">
                    <div className="flex h-full flex-col justify-between rounded-xl bg-black/25 p-4">
