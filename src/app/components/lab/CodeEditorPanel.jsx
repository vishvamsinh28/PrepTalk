    ...
    <section className="grid h-[34rem] min-h-0 min-w-0 grid-rows-[auto_minmax(0,1fr)] overflow-hidden bg-[#151311] lg:h-full lg:grid-rows-[4rem_minmax(0,1fr)]">
      <div className="flex min-w-0 flex-wrap items-center justify-between gap-2 border-b border-white/10 bg-[#1e1a17] px-3 py-3 sm:px-4 lg:flex-nowrap lg:px-5 lg:py-0">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <span className="hidden rounded-lg border border-white/10 bg-white/8 px-4 py-2 text-sm font-bold text-white/85 sm:inline-flex">
            JavaScript
          </span>
        ...
        <div className="flex min-w-0 flex-1 shrink-0 items-center justify-end gap-2 sm:flex-none">
          <span className="inline-flex items-center gap-1.5 rounded-md border border-[#9db87f]/40 bg-[#9db87f]/15 px-2.5 py-2 font-mono text-xs font-semibold text-[#9db87f] sm:text-sm">
            <FaClock /> {formattedTime}
          </span>
          <button onClick={onExit} className="rounded-md border border-accent/40 bg-accent/15 px-3 py-2 text-xs font-bold text-[#e4633f] sm:text-sm">
            Exit
          </button>
          <button onClick={onSubmit} disabled={isRunning} className="rounded-md bg-accent px-3 py-2 text-xs font-semibold text-white disabled:opacity-60 sm:text-sm">
            Submit
          </button>
        </div>
      </div>
      ...
      <div className="grid min-h-0 min-w-0 grid-rows-[minmax(0,1fr)_auto] overflow-hidden">
        ...
        <footer className="flex flex-wrap items-center justify-between gap-3 border-t border-white/10 bg-[#1e1a17] px-3 py-3 sm:px-4 lg:px-5">
          ...
          <button
            ...
            disabled={isRunning}
            className="inline-flex shrink-0 items-center gap-2 rounded-lg border border-[#9db87f]/40 bg-[#9db87f]/15 px-4 py-2 text-sm font-semibold text-[#9db87f] disabled:cursor-not-allowed disabled:opacity-50"
          >
            <FaPlay />
